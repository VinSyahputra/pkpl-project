...
<div class="mx-auto col-10 col-md-6 px-4 py-5">
    ...
    <div class="card">
        ...
        <?php endif; ?>
        <div class="card-body">
            <form action="/Ruangan/save/<?= $nama_ruangan; ?>" method="post">
                <?= csrf_field(); ?>
                ...
                <div class="input-group justify-content-between">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= $validation->hasError('cp') ? 'is-invalid' : ''; ?>" id="cp" name="cp" value="<?= old('cp'); ?>" placeholder="No Telepon">
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="timepicker form-control <?= $validation->hasError('waktu_mulai') ? 'is-invalid' : ''; ?>" id="waktu_mulai" name="waktu_mulai" value="<?= old('waktu_mulai'); ?>" autocomplete="off">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="timepicker form-control <?= $validation->hasError('waktu_berakhir') ? 'is-invalid' : ''; ?>" id="waktu_berakhir" name="waktu_berakhir" value="<?= old('waktu_berakhir'); ?>" autocomplete="off">
                    <div class="invalid-feedback">
